...
void LtePhyUe::handoverHandler(LteAirFrame* frame, UserControlInfo* lteInfo)
{
    ...
    else
    {
        ...
        for (it = rssiV.begin(); it != rssiV.end(); ++it)
            //std::cout << "lteInfo->getSourceId()" << *it << endl;
            rssi += *it;
        rssi /= rssiV.size();
    }
...
void LtePhyUe::triggerHandover()
{
    ...
    //
    // printconsole - gilteun
    //
    std::cout << "####Handover starting:####" << endl;
    std::cout << "current master: " << masterId_ << endl;
    std::cout << "current rssi: " << currentMasterRssi_ << endl;
    std::cout << "candidate master: " << candidateMasterId_ << endl;
    ...
    std::cout << NOW << " LtePhyUe::triggerHandover - UE " << nodeId_ << " is starting handover to eNB " << candidateMasterId_ << "... " << endl;
    //
    // end printconsole - gilteun
    //
