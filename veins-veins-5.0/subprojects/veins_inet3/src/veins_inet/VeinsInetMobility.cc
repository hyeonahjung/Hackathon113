...
void VeinsInetMobility::nextPosition(const inet::Coord& position, std::string road_id, double speed, double angle)
{
    ...
    //
    //start - print out data - gilteun
    //
//
//    char nowlog[1024];
//    sprintf(nowlog, "x:%f, y:%f, z:%f, S:%f A:%f", position.x, position.y, position.z, speed, -angle);
//    std::cout << nowlog << endl;
//
    //
    //end00 - print out data - gilteun
    //
